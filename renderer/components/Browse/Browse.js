...
class Browse {
   ...
   render = async () => {
      ...
      const browse_heading = create_heading({
         level:'h1',
   ...
   get_items = async (retain_actives = true) => {
      ...
      if(this.#browse_context) {
         ...
         try {
            ...
            const collection_items_obj = await window.collection_items_api.getItems(this.#browse_context.page)
            ...
            if (typeof collection_items_obj != "undefined") {
               ...
               if(collection_items_obj.outcome === 'success') {
                  ...
                  const bottom_pagination_nav = new PaginationNav('bottom',this.go_to_page,page_count,this.#browse_context.page)  //this.go_to_page,page_count,this.#browse_context.page
